setwd("F:/bonato/CoMOLA_fallow_0625/models/model_all")
sink("F:/bonato/CoMOLA_fert_0610/models/model_all/console.txt", append=FALSE)
###################################################

# Title: All models for optimization (fallow land scenario)
# Purpose: This code is used to model habitat quality, habitat connectivity and SWAT related indicators with the fallow land scenario implemented
# Reference: 
# Author: Marta Bonato 
# Date: last modified on 25 June 2024
...
# This measure_location.csv is different from the status quo, because the possible implementable fallow lands are added
...
lu_Schoeps_snh <- lu_Schoeps %>%
  filter(lu_1 == 'rnge'| lu_1 == 'rngb' | lu_1 == 'wetl', lu_1 == 'fall')
